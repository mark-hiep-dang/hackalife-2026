export const translations = {
  ...
  correctFeedback: 'Pằng! Chuẩn không cần chỉnh! 🎯',
  incorrectFeedback: 'Chíu~ Trượt rồi, thử lại nha! 💦',
  correctFeedbackSub: 'Llama tự hào về bạn lắm đó, tiếp tục phát huy nhé!',
