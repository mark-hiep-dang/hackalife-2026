    ...
    <div className="flex flex-col gap-8 pop-in max-w-4xl mx-auto w-full">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <span className="text-xs font-extrabold text-[#101A24] uppercase tracking-widest bg-[#00B4D8] border border-[#101A24]/10 px-3 py-1 rounded shadow-sm -rotate-2">
            {t.learnTitle}
          </span>
      ...
      {isDone ? (
        <div className="card-pro p-8 md:p-12 text-center bg-white pop-in">
          <CheckCircle2 size={80} strokeWidth={3} className="text-[#2563EB] mx-auto mb-6" />
          ...
          <button onClick={handleFinish} disabled={submitting} className="btn-pro-primary bg-[#00B4D8] w-full text-2xl py-6">
        ...
        <div className="card-pro p-8 md:p-12 pop-in bg-white">
          ...
          <div className="bg-[#101A24] border border-[#101A24]/10 rounded-2xl p-6 text-white shadow-sm -rotate-1 mb-10">
            <div className="flex items-center gap-2 mb-3">
              <Zap size={20} strokeWidth={3} className="text-[#00B4D8]" />
              <strong className="text-xs font-extrabold uppercase tracking-widest text-[#00B4D8]">{t.tipLabel}</strong>
            </div>
            <p className="text-base font-bold leading-relaxed">{cards[cidx].tip_vn}</p>
          </div>

          <button onClick={() => { setCidx(p => p + 1); playPang(); }} className="btn-pro-primary bg-[#2563EB] text-white w-full text-xl py-5">
