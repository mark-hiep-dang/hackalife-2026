...
// @typedef {"GENERATE_CURRICULUM"|"GENERATE_LESSON_KIT"|"GENERATE_COMPLEX_SCENARIO"|"GENERATE_RESCUE_EXPEDITION"|"SUGGEST_COMPLEX_QUALITY_FIX"|"REWRITE_QUESTION"|"GENERATE_FLASHCARDS"|"SUMMARIZE_INSIGHT"|"EXPLAIN_METRIC"|"GENERATE_LLAMA_COPY"|"TRAINER_COPILOT_SIMPLE"|"TRAINER_COPILOT_COMPLEX"|"LEARNER_CHAT"} LlamaAITask
